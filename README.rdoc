...
This is release 1.1, which fixes an issue with early initialization of an
injected Stockpile instance during adaptation. See {the reported
issue}[https://githbub.com/halostatue/stockpile/issues/2] for a complete
